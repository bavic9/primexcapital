...
const Courses = () => {
    return (
        <div className='text pb-32 pt-6'>
            <div className=' flex flex-col justify-between lg:w-3/4 lg:flex-row items-center mx-auto gap-10 space-y-10 lg:space-y-0 lg:px-0 px-4'>
                ...
                <div className='relative lg:w-1/2 lg:px-0 md:px-4 flex justify-center flex-col space-y-6'>
                    ...
                    <div className='lg:absolute -bottom-20 -left-[25%] flex justify-between items-center bg-slate-600 text-white px-4 py-6 rounded-xl'>
