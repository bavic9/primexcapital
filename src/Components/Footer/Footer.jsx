...
const Footer = () => {
  return (
    <div className=' bg-gray-100 px-10 mt-auto w-full justify-center py-6'>
        <div className='w-[90%] m-auto flex flex-col lg:flex-row justify-between items-center space-y-8 border-t-2 border-gray-400 py-4 md:py-8 lg:py-0 lg:px-14'>
