            ...
            <div className='m-auto lg:px-10 pt-5 lg:pt-16 lg:py-16 flex flex-col lg:justify-around justify-center lg:flex-row items-center space-y-16 lg:space-y-0 animationUp'>
                ...
                <div className='lg:w-1/2 md:p-16 lg:m-auto ' data-aos="fade-right">
                    ...
                    <div className='flex lg:justify-start justify-center items-center gap-3 md:space-x-6 py-6'>
                        <button className='rounded-lg ease-out duration-500 hover:shadow-lg border border-blue text-blue font-varela font-semibold md:text-2xl text-lg px-6 lg:px-10 py-5 hover:text-white hover:bg-blue'>
                            Join Free Classes
                        </button>
                        <button className='rounded-lg ease-out duration-500 hover:shadow-lg border border-blue text-blue font-varela font-semibold md:text-2xl text-lg px-4 lg:px-6 py-5 hover:text-white hover:bg-blue'>
                            Enroll Now
                        </button>
                    </div>
                </div>
