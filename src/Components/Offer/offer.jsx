  ...
  return (
    <div className='w-[90%] lg:space-y-[10rem] space-y-20 py-[10rem] m-auto'>
        ...
        <div className='flex flex-col lg:flex-row justify-around items-center space-y-16 lg:space-y-0 lg:w-[75%] lg:m-auto '>
            <div className='mx-4 lg:max-h-[420px] md:w-[300px] border-blue border-2 rounded-3xl space-y-10 pb-16 shadow-lg shadow-gray-300 transition delay-150 ease-in-out duration-1000 lg:hover:scale-110'  data-aos="fade-up">
            ...
            <div className='mx-4 lg:max-h-[420px] md:w-[300px] border-blue border-2 rounded-3xl space-y-10 pb-16 shadow-lg shadow-gray-300 transition delay-150 ease-in-out duration-1000 lg:hover:scale-110' data-aos="fade-up" data-aos-duration="800">
