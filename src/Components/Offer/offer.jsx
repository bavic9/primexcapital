  ...
  return (
    <div className='w-[90%] lg:space-y-[10rem] space-y-20 py-[10rem] m-auto'>
        ...
        <div className='text-center space-y-10' data-aos="fade-up">
            <h1 className='md:text-5xl text-3xl w-1/2 md:w-4/5 text-center m-auto font-varela font-semibold'>What we have to <span className='text-blue'>offer</span></h1>
        ...
        <div className='flex flex-col lg:flex-row justify-around items-center space-y-16 lg:space-y-0 lg:w-[75%] lg:m-auto '>
            <div className='mx-4 lg:max-h-[420px] md:w-[300px] border-blue border-2 rounded-3xl space-y-10 pb-16 shadow-lg shadow-lightBlue transition delay-150 ease-in-out duration-1000 lg:hover:scale-110'  data-aos="fade-up">
            ...
            <div className='mx-4 lg:max-h-[420px] md:w-[300px] border-blue border-2 rounded-3xl space-y-10 pb-16 shadow-lg shadow-lightBlue transition delay-150 ease-in-out duration-1000 lg:hover:scale-110' data-aos="fade-up" data-aos-duration="800">
